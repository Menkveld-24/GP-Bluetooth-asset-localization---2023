...
// This file was run for both cache_enabled as cache_disabled as it is
// a server configuration that was changed.
...
export function handleSummary(summary) {
    ...
    let result = {};
    result[`${options.vus}_${options.duration}_${Date.now()}_summary_caching.json`] = JSON.stringify(summary);
    return result;
}