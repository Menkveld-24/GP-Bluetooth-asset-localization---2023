...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_AMS_CCS811_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SEMTECH_SX1509B_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LIS2DH12_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_BUF_SIZE, 384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LBS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LBS_POLL_BUTTON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LBS_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LBS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_MTU, 252);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 27);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SFLOAT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SET, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_SMP_WORKQUEUE_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_SMP_WORKQUEUE_THREAD_PRIO, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_BUF_USER_DATA_SIZE, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x32000);
